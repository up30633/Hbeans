...
unsigned char pchMessageStart[4] = { 0xde, 0xcb, 0x5e, 0xea};
int64 nChainStartTime = 1512613387;
...
const string strMessageMagic = "Hbeans Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Hbeans
    bool fStrictPayToScriptHash = true; // Always active in Hbeans
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Hbeans", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "2017.12.22 Hbeans,wish is a great Coin,wish is a great Coin!!";
        CTransaction txNew;
      ...
      if (true  && (block.GetHash() != hashGenesisBlock))
        ...
        assert(block.hashMerkleRoot == uint256("0x28ac030c23b29ce848dcdd5bee8877e6566d15541acbc2defa8d019cf6f8e7bd"));
